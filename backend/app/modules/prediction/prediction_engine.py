...
from app.modules.prediction.response_builder import build_recommendations
from app.services.medical_report_service import build_clinical_report
...
def execute(disease_slug: str, raw_features: Dict[str, Any], profile: Dict[str, Any] | None) -> dict:
    ...
    doctor_explanation = build_clinical_report(result, disease_cfg, raw_features, profile)
