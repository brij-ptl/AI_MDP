    ...
    <header className="flex h-20 items-center justify-between border-b border-border px-6 bg-surface/10">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          {menuOpen && (
            <div className="absolute right-0 mt-2 w-48 rounded-xl border border-border bg-surface p-2 shadow-xl animate-fadeIn z-50">
              {user && (
              ...
              <Link 
                href="/profile" 
                className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm text-text hover:bg-bg transition-colors"
              ...
              <button 
                type="button"
                className="flex w-full items-center gap-2 rounded-lg px-3 py-2 text-sm text-red-500 hover:bg-red-500/10 transition-colors mt-1"
