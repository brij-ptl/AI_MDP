  ...
  return (
    <Container className="py-20">
      ...
      <div className="mx-auto mt-12 max-w-3xl space-y-6 text-muted">
        <p>
          Vitalis AI was founded to close the gap between symptom onset and diagnosis. Our multi-disease
        ...
        <p>
          We are not a replacement for professional medical care. Vitalis AI is a screening and triage layer —
